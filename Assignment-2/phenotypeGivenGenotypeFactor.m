...
Indx_val = IndexToAssignment(1:prod(phenotypeFactor.card),phenotypeFactor.card)(:,1) == 1;
phenotypeFactor.val(Indx_val) = alphaList;
phenotypeFactor.val(!Indx_val) = 1-alphaList;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%