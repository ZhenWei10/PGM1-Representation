...
Indx_aa = IndexToAssignment(1:prod(phenotypeFactor.card),phenotypeFactor.card)(:,2) == 3;
Indx_disease = IndexToAssignment(1:prod(phenotypeFactor.card),phenotypeFactor.card)(:,1) == 1;

if isDominant == 1 
phenotypeFactor.val(!Indx_aa & Indx_disease) = 1; 
phenotypeFactor.val(Indx_aa & !Indx_disease) = 1; 
end
