...
indx_M = IndexToAssignment(1:prod(genotypeFactor.card),genotypeFactor.card);

% 1: AA
% 2: Aa
% 3: aa
for(i = 1:size(indx_M,1)) 
P1_alleles = genotypesToAlleles(indx_M(i,2),:);
P2_alleles = genotypesToAlleles(indx_M(i,3),:);
C_Genotype1 = allelesToGenotypes(P1_alleles(1),P2_alleles(1));
C_Genotype2 = allelesToGenotypes(P1_alleles(1),P2_alleles(2));
C_Genotype3 = allelesToGenotypes(P1_alleles(2),P2_alleles(1));
C_Genotype4 = allelesToGenotypes(P1_alleles(2),P2_alleles(2));
genotypeFactor.val(i) = mean([C_Genotype1,C_Genotype2,C_Genotype3,C_Genotype4] == indx_M(i,1));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%